...
{
    $statements = array(
        "INSERT INTO tenants (id,name,is_active,created_by) VALUES
            (101,'Admin A Account',1,1),(201,'Admin B Account',1,1)",
        "INSERT INTO users (id,name,mobile_no,role,tenant_id,is_active,created_by) VALUES
        ...
        "INSERT INTO properties (id,tenant_id,property_code,property_name,is_active,created_by) VALUES
            (101,101,'A_P1','Admin A Property One',1,101),
            (102,101,'A_P2','Admin A Property Two',1,101),
            (201,201,'B_P3','Admin B Property Three',1,201)",
        "INSERT INTO user_property_access (tenant_id,user_id,property_id,assigned_by) VALUES
        ...
        "INSERT INTO rooms
            (id,property_id,room_code,room_no,category_id,floor_no,selling_price,is_active)
            VALUES
            (10101,101,'ROOM500','500',10101,'5',2500,1),
            (10201,102,'ROOM500','500',10201,'5',2600,1),
            (20101,201,'ROOM500','500',20101,'5',2700,1)",
        "INSERT INTO customers
            (id,tenant_id,customer_code,customer_name,phone,is_active)
            VALUES
        ...
        "INSERT INTO booking_details
            (id,tenant_id,property_id,booking_number,customer_id,status_id,property_name,
        ...
        "INSERT INTO customer_identities
            (id,tenant_id,property_id,customer_id,booking_id,identity_type,identity_number)
...
try {
    ...
    expect_true('fixture has two admin tenants and three active properties',
        (int) scalar_value($fixture_db, "SELECT COUNT(*) FROM tenants WHERE id IN (101,201)") === 2
        && (int) scalar_value($fixture_db, "SELECT COUNT(*) FROM properties WHERE id IN (101,102,201) AND is_active=1") === 3);
    ...
    $fixture_db->query(
        "INSERT INTO rooms (id,property_id,room_code,room_no,category_id,is_active) VALUES (10103,101,'ROOM_NOCAT','501',NULL,1)"
    );
    ...
    $fixture_db->query(
        "INSERT INTO booking_details (id,tenant_id,property_id,booking_number,customer_id,status_id,room_category_id,room_id) VALUES (11003,101,101,'NO_CATEGORY_ROOM',10102,1,NULL,10103)"
    );
    ...
    expect_sql_rejected($fixture_db, 'user assignment cannot point at another tenant property',
        "INSERT INTO user_property_access (tenant_id,user_id,property_id,assigned_by) VALUES (101,111,201,101)");
    expect_sql_rejected($fixture_db, 'assignment tenant cannot be forged to match foreign property',
        "INSERT INTO user_property_access (tenant_id,user_id,property_id,assigned_by) VALUES (201,111,201,101)");
    expect_sql_rejected($fixture_db, 'super-admin role rejects a tenant id',
        "INSERT INTO users (name,mobile_no,role,tenant_id,is_active) VALUES ('Bad Super','9000099901','super_admin',101,1)");
    expect_sql_rejected($fixture_db, 'normal user role rejects a null tenant',
        "INSERT INTO users (name,mobile_no,role,tenant_id,is_active) VALUES ('Bad User','9000099902','user',NULL,1)");

    $fixture_db->query("INSERT INTO customers (id,tenant_id,customer_code,customer_name,phone) VALUES (11001,101,'PHONE_A','Phone A','7999999999')");
    $fixture_db->query("INSERT INTO customers (id,tenant_id,customer_code,customer_name,phone) VALUES (21001,201,'PHONE_B','Phone B','7999999999')");
    ...
    expect_sql_rejected($fixture_db, 'duplicate customer phone is rejected inside one tenant',
        "INSERT INTO customers (id,tenant_id,customer_code,customer_name,phone) VALUES (11002,101,'PHONE_C','Phone C','7999999999')");
    $fixture_db->query("INSERT INTO booking_details (id,tenant_id,property_id,booking_number,customer_id,status_id,room_category_id,room_id) VALUES (11001,101,101,'SHARED_CODE',10101,1,10101,10101)");
    $fixture_db->query("INSERT INTO booking_details (id,tenant_id,property_id,booking_number,customer_id,status_id,room_category_id,room_id) VALUES (11002,101,102,'SHARED_CODE',10101,1,10201,10201)");
    ...
    expect_sql_rejected($fixture_db, 'duplicate booking number is rejected inside one property',
        "INSERT INTO booking_details (tenant_id,property_id,booking_number,customer_id,status_id) VALUES (101,101,'SHARED_CODE',10101,1)");
    expect_sql_rejected($fixture_db, 'booking cannot combine tenant A with tenant B property',
        "INSERT INTO booking_details (tenant_id,property_id,booking_number,customer_id,status_id) VALUES (101,201,'BAD_PROPERTY',10101,1)");
    expect_sql_rejected($fixture_db, 'booking cannot combine tenant A property with tenant B customer',
        "INSERT INTO booking_details (tenant_id,property_id,booking_number,customer_id,status_id) VALUES (101,101,'BAD_CUSTOMER',20101,1)");
    expect_sql_rejected($fixture_db, 'booking cannot use a room from another property',
        "INSERT INTO booking_details (tenant_id,property_id,booking_number,customer_id,status_id,room_id) VALUES (101,101,'BAD_ROOM',10101,1,10201)");
    expect_sql_rejected($fixture_db, 'booking cannot use a category from another property',
        "INSERT INTO booking_details (tenant_id,property_id,booking_number,customer_id,status_id,room_category_id) VALUES (101,101,'BAD_CATEGORY',10101,1,10201)");
    expect_sql_rejected($fixture_db, 'identity cannot attach a booking from another property',
        "INSERT INTO customer_identities (tenant_id,property_id,customer_id,booking_id,identity_type) VALUES (101,102,10101,10101,'passport')");
    expect_sql_rejected($fixture_db, 'identity cannot attach booking to another same-tenant customer',
        "INSERT INTO customer_identities (tenant_id,property_id,customer_id,booking_id,identity_type) VALUES (101,101,10102,10101,'passport')");
    expect_sql_rejected($fixture_db, 'property with operational history is protected by RESTRICT',
        "DELETE FROM properties WHERE id=101");
    expect_true('tenant-shared customer is reused by bookings in two properties',
        (int) scalar_value($fixture_db, "SELECT COUNT(DISTINCT property_id) FROM booking_details WHERE tenant_id=101 AND customer_id=10101 AND property_id IN (101,102)") === 2);
    ...
    $active_property_result = $fixture_db->query('SELECT id FROM properties WHERE is_active=1 ORDER BY id');
    ...
    $fixture_db->query('UPDATE properties SET is_active=0 WHERE id=102');
    ...
    $fixture_db->query('UPDATE properties SET is_active=1 WHERE id=102');
    ...
    expect_true('assignment revocation immediately removes P2 but preserves P1',
        row_ids($properties->list_authorized_for_user($user_multi, TRUE)) === array(101));
    $fixture_db->query("INSERT INTO user_property_access (tenant_id,user_id,property_id,assigned_by) VALUES (101,112,102,101)");
    ...
    $fixture_db->query('UPDATE tenants SET is_active=0 WHERE id=101');
    expect_true('tenant deactivation blocks owner and staff contexts',
        $users->get_active_by_mobile('9000000101') === NULL
        && $users->get_active_by_mobile('9000000111') === NULL);
    $fixture_db->query('UPDATE tenants SET is_active=1 WHERE id=101');
