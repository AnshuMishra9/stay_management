<?php $page_title = 'Admin accounts'; $this->load->view('access/management_head', compact('page_title')); ?>
<div class="erp-card mgmt-card">
    ...
    <div class="erp-page-head">
        <div>
            ...
            <p class="erp-sub">Each admin owns one isolated account and may own multiple properties</p>
        </div>
    ...
    <div class="erp-table-scroll">
        <table class="erp-table mgmt-table">
            <thead>
                <tr><th>Admin</th><th>Mobile</th><th>Account</th><th>Properties</th><th>Users</th><th>Status</th><th>Actions</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="erp-actions">
                            ...
                            <form method="post" action="<?= site_url('admins/delete/'.$admin->id) ?>" onsubmit="return confirm('Delete this unused admin, or deactivate it when history exists?');">
                                <input type="hidden" name="session_write_token" value="<?= html_escape($session_write_token) ?>">
        ...
        <?php if (empty($admins)): ?>
            <div class="erp-state">No admin accounts have been created.</div>
        <?php endif; ?>
    </div>

    <div class="erp-count"><?= count($admins) ?> admin account<?= count($admins) != 1 ? 's' : '' ?></div>
</div>
